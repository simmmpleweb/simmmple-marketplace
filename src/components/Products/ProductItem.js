...
import { Tag, Flex, Box, Image, Text, Icon, } from "@chakra-ui/react";
...
const ProductItem = ({ image, tag, price, title, category, path, downloads, date }) => {
  return (
    <NavLink to={path}>
      <Card>
        <CardBody>
            ...
            <Flex
              ...
              p='0px 12px 0px 12px'>
                <Flex align="center">
                  ...
                  <Flex align="center">
                      <Icon as={FiDownload} color="brand.300" w="14px" h="14px" me="6px"/>
                      <Text fontSize="sm" color="brand.300" fontWeight="500">{downloads}</Text>
                  </Flex>
