  ...
  useEffect(() => {
    ...
    routes.forEach(route => {
      if (route.path.lastIndexOf("/") !== 0) {
        if (window.location.href.includes(route.path.slice(0, route.path.lastIndexOf("/")))) {
      ...
      >
        ...
        >
          <Flex
            ...
            h="100%"
          >
            <Text color={secondary ? "#878CBD" : "#fff"} fontWeight="normal" fontSize="sm" me="4px">
              Explore
            </Text>
            <Icon as={GoChevronDown} w="12px" h="12px" color={secondary ? "#878CBD" : "#fff"} mt="4px" />
              ...
              >
                <Grid templateColumns="repeat(2, 1fr)">
                  ...
                  >
                    ...
                    <Text color={secondary ? "#878CBD" : "#fff"} fontSize="sm" mt="20px" mb="26px">
        ...
        <Flex align="center" justify="flex-end">
          <Button
            ...
            me={{ sm: "14px", lg: "0px" }}
          >
            <Text fontSize="sm" fontWeight="500" color={secondary ? "brand.300" : "#fff"} lineHeight="13px">
              Get Started
            </Text>
          </Button>
          <IconBox
