...
const Product = (props) => {
  ...
  return (
    <Layout>
      <Flex bg="#fff" pb="225px" pt="90px" direction="column">
        <Grid
          templateColumns="2.7fr 1fr"
          gap="40px"
          maxW="1170px"
          mx="auto"
          position="relative"
        >
          ...
          <Flex
            direction="column"
            pt="75px"
            // position={(scroll[900] && scroll[3000]) ? "absolute" : ((scroll[900] && !scroll[3000]) ? "fixed" : "absolute")}
            // right={scroll[900] ? "50px" : "0"}
            // top={scroll[900] ? "-700px" : null}
            // bottom={scroll[3000] ? "0" : null}
            w="312px"
          >
