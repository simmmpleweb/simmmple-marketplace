import {
  Box, Button, Flex, Grid, Image, Link,
  ListItem, Menu, MenuList, Text, UnorderedList, useDisclosure
...
// Icons
import {
  Done, Help, HelpOutline, LeftButtonEffect, Lock, RightButtonEffect,
  SimmmpleLogoBundle, WarningM
              ...
              >
                <Flex flexDirection="column">
                  <Flex align="center" mb="5px"  >
                    ...
                    <HelpOutline w="18px" color="brand.700" mt="5px" onMouseEnter={onOpenCompany} onMouseLeave={onCloseCompany}/>
                    </NavLink>
              ...
              >
                <Flex flexDirection="column">
                  <Flex align="center" mb="5px">
                    ...
                    <NavLink to="/licenses">
                      <HelpOutline w="18px" color="brand.700" mt="5px" onMouseEnter={onOpenEnterprise} onMouseLeave={onCloseEnterprise}/>
                    </NavLink>
