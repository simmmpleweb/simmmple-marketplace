...
const Bundles = () => {
  ...
  return (
    <Flex direction='column' bg='#fff' overflowX='hidden' pt='280px'>
      <Flex
        justify='center'
        align='center'
        bgSize='cover'
        ...
        <Flex
          ...
          <Text
            ...
            w='773px'
            letterSpacing='-0.2px'>
            Simmmple is a marketplace that provides premium UI & Web resources.
            It's not only the perfect place to find the latest and greatest Web
            Desing freebies, but also a place to learn advanced techniques and
            build better & faster with our premium products.
          </Text>
